...
function fadeX() {
    $("#imageP1Div").animate({ opacity: 0.2 }, 600, function () {
        $(this).animate({ opacity: 1 }, 600, fadeX);
    });
}

function fadeO() {
    $("#imageP2Div").animate({ opacity: 0.2 }, 600, function () {
        $(this).animate({ opacity: 1 }, 600, fadeO);
    });
}
