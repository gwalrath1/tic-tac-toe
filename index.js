...
(function ($, undefined) {
    ...
    $(function () { // put jQuery code here.
        ...
        const $checkWinner = (boxA, boxB, boxC) => {
            // invoke custom function in jquery by writing $.customFunction(). Alternatively, $(this).customFunction if you wanna call it on a specific thing. So like $.checkWinner()
            if (boxA.$img.html() === 'images/use/x-neon.png' && boxB.$img.html() === 'images/use/x-neon.png' && boxB.$img.html() === 'images/use/x-neon.png') { // don't ask me if this is correct, just jotting my thoughts down lol.
                $winner = true;
            ...
            if (boxA.$img.html() === 'images/use/o-neon.png' && boxB.$img.html() === 'images/use/o-neon.png' && boxB.$img.html() === 'images/use/o-neon.png') {
                $winner = true;
        ...
        const $checkOutcomes = () => {
            $checkWinner($box0, $box1, $box2); // rows winning combos
            $checkWinner($box3, $box4, $box5);
            $checkWinner($box6, $box7, $box8);
            $checkWinner($box0, $box3, $box6); // columns winning combos
            $checkWinner($box1, $box4, $box7);
            $checkWinner($box2, $box5, $box8);
            $checkWinner($box0, $box4, $box8); // diagonal winning combos
            $checkWinner($box2, $box4, $box6);
        }
